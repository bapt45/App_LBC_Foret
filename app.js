(function () {
    ...
    const STORAGE_KEY = 'inventaireForestierV25';
    const LEGACY_STORAGE_KEYS = ['inventaireForestierV23', 'inventaireForestierV22', 'inventaireForestierV21', 'inventaireForestierV2'];
